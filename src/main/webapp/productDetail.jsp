...
<%--                        <h5> <del>$ 60.00</del> $40.79</h5>--%>
                        ...
                        <input type="text" value="$40.79" style="margin-left: 40px;">
                        <br>
                        <br>
                        <label id="newQuan">Quantity</label>
                        <input type="text" value="$40.79" style="margin-left: 21px;">
...
<%--						</ul>--%>
						...
						<div class="price-box-bar">
							<div class="cart-and-bay-btn">
								<a class="btn hvr-hover" data-fancybox-close="" href="#">Update</a>
                                <br>
                                <div>
                                    <br>
