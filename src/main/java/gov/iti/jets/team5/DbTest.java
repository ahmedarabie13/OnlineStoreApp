...
//        Set<Category> catsV = new HashSet<>(); catsV.add(cat4);
//        Set<Category> catsD = new HashSet<>(); catsD.add(cat1);
//        Set<Category> catsVS = new HashSet<>(); catsVS.add(cat2);
...
//        p10.setCategories(catsS);
        ...
        entityManager.persist(p5); entityManager.persist(p6);
