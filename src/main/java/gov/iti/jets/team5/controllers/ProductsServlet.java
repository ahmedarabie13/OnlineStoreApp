...
//        System.out.println("productsCount = " + productsCount);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException{
        ...
        if(toDelete != null){
            ...
            productDto.setProductName(name); productDto.setProductDescription(desc);
            productDto.setProductPrice(Double.parseDouble(price)); productDto.setProductQuantity(Integer.parseInt(quan));
